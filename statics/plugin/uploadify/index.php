...
<div class="W">
	...
	<div class="Wrap">
		...
		<div class="Cont">
			<p class="Note">最多上传<strong><?php echo 123; ?></strong>个附件,单文件最大<strong><?php echo GetRealSize($size); ?></strong>,类型<strong><?php echo GetUpType($type); ?></strong></p>
			<div class="flashWrap">
