...
imagecopymerge($dst, $src, 595, 360, 0, 0, $src_w, $src_h, 100);
...
switch ($dst_type) {
    case 1://GIF
        ...
        imagegif($dst,'/statics/templates/yungou/images/mobile/yao/'.$id.'.gif');
        break;
    case 2://JPG
        header('Content-Type: image/jpeg');
        imagejpeg($dst,'/statics/templates/yungou/images/mobile/yao/'.$id.'.jpg');
        break;
    case 3://PNG
        header('Content-Type: image/png');
        imagepng($dst,'/statics/templates/yungou/images/mobile/yao/'.$id.'.png');
        break;
    default:
        break;
}
