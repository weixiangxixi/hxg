                ...
                if (t.flyCutterAllNum > t.useFlyCutterNum) {
                    ...
                    2 == this.game.level) {
                        ...
                        n = function() {
                            ...
                            e.getChildByName("time").getComponent(cc.Label).string = "体验结束",
    ...
    game: [function(i, e, t) {
        ...
        cc.Class({
            ...
            onLoad: function() {
                ...
                this.firstNums ? isNaN(this.firstNums) && (this.firstNums = 8) : this.firstNums = 8,
                this.secondNums ? isNaN(this.secondNums) && (this.secondNums = 12) : this.secondNums = 12,
                this.yinliang = 1,
            ...
            gameInit: function() {
                ...
                1 == this.level ? (this.flyCutterAllNum = this.firstNums,
                t.children[0].children[0].active = !0,
                e.spriteFrame = this.target.getComponent("gameTarget").sprite_frames[0]) : 2 == this.level && (this.flyCutterAllNum = this.secondNums,
                t.children[0].children[0].active = !0,
            ...
            showGuodu: function() {
                ...
                var i = this;
                1 == this.level ? (this.guodu1.active = !0,
                this.guodu2.active = !1,
                this.guodu3.active = !1) : 2 == this.level && (this.guodu1.active = !1,
