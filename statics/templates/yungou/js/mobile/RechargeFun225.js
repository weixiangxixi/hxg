...
/*            var pw = $('#card_pwd').val();
        ...
        var addmoney = function(payid){
            ...
            if(money < 20 && (payid == 23 || payid == 24 || payid == 25 || payid == 9 || payid == 99 || payid == 20 || payid == 999 || payid == 9999 || payid == 99999 || payid == 999999) ){
                toast('该支付充值最小金额20元')
                return false;
            }
            ...
            switch(payid){
                case 1111:
                    addmoneyCallback = aliPayAddmoneyCallback     //支付宝口令
                    break;
                case 9:
                ...
                case 99:
                    ...
                    break;
                case 999:
                    addmoneyCallback = wxPayAddmoneyCallback11     //微信3
                    break;
                case 9999:
                    addmoneyCallback = wxPayAddmoneyCallback111     //微信4
                    break;
                case 99999:
                    addmoneyCallback = wxPayAddmoneyCallback1111     //微信5
                    break;
                case 999999:
                    addmoneyCallback = wxPayAddmoneyCallback11111     //微信5
                    break;
                case 20:
        ...
        var aliPayAddmoneyCallback = function(data){
            window.location.href = '/index.php/mobile/home/userrecharge9';
        }
        var wxPayAddmoneyCallback11111 = function(data){
            //window.location.href = '/api/cnmobi/gopay?total='+data;
            window.location.href = '/index.php/mobile/wechat11111/gopay/'+data;
        }
        var wxPayAddmoneyCallback1111 = function(data){
            //window.location.href = '/api/cnmobi/gopay?total='+data;
            window.location.href = '/index.php/mobile/wechat1111/gopay/'+data;
        }
        var wxPayAddmoneyCallback111 = function(data){
            //window.location.href = '/api/cnmobi/gopay?total='+data;
            window.location.href = '/index.php/mobile/wechat111/gopay/'+data;
        }
        var wxPayAddmoneyCallback11 = function(data){
            //window.location.href = '/api/cnmobi/gopay?total='+data;
            window.location.href = '/index.php/mobile/companypay/gopay/'+data;
        }
        var wxPayAddmoneyCallback1 = function(data){
          	//window.location.href = '/api/cnmobi/gopay?total='+data;
          	window.location.href = '/index.php/mobile/yaoqianshu/gopay/'+data;
        }
