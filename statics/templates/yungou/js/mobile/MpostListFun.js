                ...
                function(D) {			
                    ...
                    if (D.code == 0) {					
                        ...
                        for (var y = 0; y < B; y++) {
                            ...
                            A += '<li class="' + (y + 1 == B ? "bornone": "") + '" onclick="location.href=\'' + x + '\'"><a class="fl z-Limg" href="' + x + '"><img src="' + Gobal.LoadPic + '" src2="http://f.weimicm.com/' + C[y].thumb + '@!thumb_300_300" border=0 alt="" width=40></a><div class="u-sgl-r"><p class="z-sgl-tt"><a href="' + x + '" class="gray6">' + C[y].sd_title + '</a></p><p class="z-sgl-info gray9">' + C[y].sd_content + "</p><p>晒单时间：" + C[y].sd_time + "</p>";
                ...
                function(B) {
                    ...
                    if (B.code == 0) {
                        ...
                        for (var x = 0; x < z; x++) {
                            ...
                            var C = '<li class="' + (x + 1 == z ? "bornone": "") + '" id="' + A[x].id + '"><a class="fl z-Limg" href="'+Gobal.Webpath+'/mobile/mobile/item/' + A[x].id + '"><img src="' + Gobal.LoadPic + '" src2="http://f.weimicm.com/' + A[x].thumb + '@!thumb_300_300" border=0 alt=""></a><div class="u-sgl-r gray9"><p class="z-sgl-tt"><a href="'+Gobal.Webpath+'/mobile/mobile/item/' + A[x].id + '" class="gray6">' + A[x].title + "</a></p><p>幸运码：" + A[x].q_user_code + "</p><p>揭晓时间：" + A[x].q_end_time + '</p><p><a href="'+Gobal.Webpath+'/mobile/home/postsingle/' + A[x].id + '" class="z-sgl-btn">添加晒单</a></p></div><b class="z-arrow"></b></li>';
