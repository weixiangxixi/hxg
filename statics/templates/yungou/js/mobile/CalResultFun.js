        ...
        if (l.code == 0) {	
		  ...
		  if(l.contcode==0){
            ...
            var k = '<div class="infoResult">';           
                ...
                k += "<dl>截止该商品最后购买时间【" + l.itemlist[0].time + "】<em>最后100条全站购买时间记录</em></dl>";
