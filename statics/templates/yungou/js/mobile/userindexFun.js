                    ...
                    if (I.code == 0) {
                        ...
                        for (var D = 0; D < C; D++) {
                            ...
                            //E += '<img src2="'+Gobal.imgpath+'/uploads/' + F.thumb + '" src="' + Gobal.LoadPic + '"></li>';
                          	E += '<img src2="'+'http://f.weimicm.com/' + F.thumb + '@!thumb_200_200" src="' + Gobal.LoadPic + '"></li>';
                        ...
                        E += "<ul style='text-align: center;color: #f60'><li>为保证用户隐私,购买记录只显示最新30条</li></ul>"
                        m.append(E);
                        s = "";
                        loadImgFun();
                        if (u > x.EIdx) {
                    ...
                    if (z.code == 0) {
                        ...
                        for (var A = 0; A < E; A++) {
                            ...
                            //B += '<img src2="'+Gobal.imgpath+'/uploads/' + C.thumb + '" src="' + Gobal.LoadPic + '"></li>';
                          	B += '<img src2="'+'http://f.weimicm.com/' + C.thumb + '@!thumb_200_200" src="' + Gobal.LoadPic + '"></li>';
                        ...
                        B += "<ul style='text-align: center;color: #f60'><li>为保证用户隐私,获得记录只显示最新30条</li></ul>"
                        e.append(B);
                        s = "";
                        loadImgFun();
                        if (u > x.EIdx) {
