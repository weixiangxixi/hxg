$(function() {
    ...
    var b = function() {
        ...
        var qfv = parseInt($("#hidQfMoney").val());
        ...
        var f = function(y) {
            ...
            if (y > 0) {
                ...
                qf.parent().addClass("z-pay-grayC");
                qf.parent().css('color','#CCC');
                qf.attr("sel", "0").attr("class", "z-pay-ment").next("span").html('全返余额支付<em class="orange">0.00</em>元（全返余额：' + qfv + " 元）");
        ...
        var qfx = function(y) {
            ...
            if (y > 0) {
                ...
                qf.parent().removeClass("z-pay-grayC");
                qf.parent().css('color','#22AAFF');
                qf.attr("sel", "1").attr("class", "z-pay-mentsel").next("span").html('全返余额支付<em class="orange">' + y + ".00</em>元（全返余额：" + qfv + " 元）");
        ...
        $("li", m).each(function(y) {
            ...
            if (y == 0) {
                ...
                z.click(function() {
                    ...
                    h.html('<s class="z-arrow"></s>选择<b class="z-mlr">' + r + "</b>支付" + ((g > 0 || w > 0) ? "剩余": "") + '<em class="orange wechat">' + e + ".00</em>元")
        ...
        if (e > 0) {
            ...
            h.removeClass("z-pay-grayC").html('<s class="z-arrow"></s>选择<b class="z-mlr">' + r + "</b>支付" + ((g > 0 || w > 0) ? "剩余": "") + '<em class="orange wechat">' + e + ".00</em>元 (大于10元才可支付)").nextAll().show();
