$(function() {
            ...
            function(q) {			
                ...
                if (q.code == 0) {				 
                    ...
                    for (var p = 0; p < r; p++) {
						...
						if(parseInt(n[p].cateid) == '168'){
                          var y = '<em class="cat-lottery"></em>';
                        }else if(parseInt(n[p].cateid) == '173'){
                            var y = '<em class="tmg-lottery"></em>';
                        }else if(parseInt(n[p].cateid) == '177'){
                            var y = '<em class="s11-lottery"></em>';
                        }else{
                            var y = '';
                        }   

                        o += '<img src="http://f.weimicm.com/' + n[p].thumb + '@!thumb_300_300" border=0 alt="">'+y+'</a><div class="u-sgl-r "><p class="z-sgl-tt"><a class="gray6">(第' + n[p].shopqishu + "期)" + n[p].shopname + "</a></p>";
    ...
    $(".pull-right").click(function(){
        var x = $(this).hasClass("glyphicon-menu-down");
        if(x){
