            ...
            function(s) {			 
                ...
                if (s.code == 0) {
                    ...
                    for (var q = 0; q < t; q++) {
                            ...
                            if(r[q].cateid == 168){
                                var y = '<span class="cat-lottery"></span>';
                            }else if(r[q].cateid == 173){
                                var y = '<span class="tmg-lottery"></span>';
                            }else if(r[q].cateid == 177){
                                var y = '<span class="s11-lottery"></span>';
                            }else{
                                var y = '';
                            }   

                            var v = '<ul id="' + r[q].id + '"><li class="revConL">' + (r[q].codeType == 1 ? '<span class="z-limit-tips">限时揭晓</span>': "") + '<img src="' + Gobal.LoadPic + '" src2="'+ 'http://f.weimicm.com/' + r[q].thumb + '@!thumb_200_200">' + y + '<span>第' + r[q].qishu + '期</span></li><li class="revConR"><dl><dd class="touxianga"><img name="uImg" uweb="' + r[q].q_uid + '" src="http://f.weimicm.com/' + r[q].img + '@!thumb_110_110"></dd><dd><span>获得者<strong>：</strong><a name="uName" uweb="' + r[q].q_uid + '" class="rUserName blue">' + r[q].q_user + '</a></span>本期购买<strong>：</strong><em class="orange arial">' + r[q].gonumber + '</em>人次</dd></dl><dt>幸运码：<em class="orange arial">' + r[q].q_user_code + '</em><br/>揭晓时间：<em class="c9 arial">' + r[q].q_end_time + '</em></dt><b class="fr z-arrow"></b></li></ul>';
    ...
    var k = function() {
        ...
        var o = function(q) {
            ...
            var p = function(t) {
                ...
                for (var r = t.length - 1; r > -1; r--) {
                    ...
                    if (e.indexOf("," + s.id + ",") < 0) {
                        ...
                        if(s.cateid == 168){
                            var y = '<span class="cat-lottery"></span>';
                        }else if(s.cateid == 173){
                            var y = '<span class="tmg-lottery"></span>';
                        }else if(s.cateid == 177){
                            var y = '<span class="s11-lottery"></span>';
                        }else{
                            var y = '';
                        }  

                        var u = $('<ul class="rNow rFirst" id="' + s.id + '"><li class="revConL"><img src="'+'http://f.weimicm.com/'+ s.thumb + '@!thumb_200_200">' + y + '<span>第' + s.qishu + '期</span></li><li class="revConR"><h4>(第' + s.qishu + "期)" + s.title + "</h4><h5>价值：￥" + CastMoney(s.money) + '</h5><p name="pTime"><s></s>揭晓倒计时 <strong><em>00</em> : <em>00</em> : <em>0</em><em>0</em></strong></p><b class="fr z-arrow"></b></li><div class="rNowTitle">正在揭晓</div></ul>');

                        u.click(function() {

                            location.href = "/index.php/mobile/mobile/item/" + $(this).attr("id");
            ...
            if (n) {
                ...
                Base.getScript(Gobal.Skin + "/js/mobile/LotteryTimeFun2.js",
