...
/*            var pw = $('#card_pwd').val();
        ...
        var addmoney = function(payid){
            ...
            if(money < 1000 && (payid == 23 || payid == 24 || payid == 25 || payid == 9) ){
                toast('该支付充值最小金额1000元')
                return false;
            }
        ...
        var wxPayAddmoneyCallback = function(data){
            window.location.href = '/index.php/mobile/unionpay/abcd/' + data;
          	//window.location.href = '/api/cnmobi/abcd?total=' + data;
