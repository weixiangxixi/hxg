        ...
        if( $('#totop').length )
          ...
          if( $('.countdown1').length ){
            ...
            $els.each(function(){
              ...
              var timer = countdown(function(ts){
                ...
                var con1 = ts.toString();
                con1 = con1.substr(0, con1.indexOf('分'));
                if (con1=='') {
                  con1 = '00';
                }else{
                  con1 = '0' + con1;
          ...
          if( $('.countdown2').length ){
            ...
            $els.each(function(){
              ...
              var timer = countdown(function(ts){
                ...
                var con2 = ts.toString();
                //console.log(con2);
                //con2 = con2.substr(0, con2.indexOf('秒'));
                  if(con2.indexOf('分')>0 || con2.indexOf('分')==0){
                      var aaa = con2.split('分')[1];
                      var bbb = aaa.split('秒')[0];


                  }else{
                      var bbb = con2.split('秒')[0];
                  }
                 if(bbb == 9 ||bbb == 8 ||bbb == 7 ||bbb == 6 ||bbb == 5 ||bbb == 4 ||bbb == 3 || bbb == 2 || bbb == 1 || bbb == 0){
                    bbb = '0' + bbb;
                 }
                 if (bbb.length >3) {
                    bbb = bbb.substr(0 , 2);
          ...
          if( $('.countdown3').length ){
            ...
            $els.each(function(){
              ...
              var timer = countdown(function(ts){
                ...
                var con3 = ts.toString();
                //console.log(con3);
                if(con3.indexOf('秒')>0 || con3.indexOf('秒')==0){
                    con3 = con3.split('秒')[1];
                    if (con3 != '') {
                       if (con3.length >3) {
                        con3 = con3.substr(0 , 2);
                      }
                    }
          ...
          $('body').on('click', '.click_for_nums', function(){
            ...
            $.get(url , function(data){
              ...
              // 添加内容
              var content = '<div style="margin-bottom:5px;">参与' + data_length + '次，参与号码：</div>'
