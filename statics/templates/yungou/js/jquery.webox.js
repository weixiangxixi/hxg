...
jwebox.goshopnow = function(shopid,path){
				...
				*{margin:0;padding:0;list-style-type:none;}
				...
				<div class="jwebox_showbox">			
					<div class="jwebox_background"></div>
						...
						<h1 class="jwebox_locked"  onselectstart="return false;">快捷支付——您将要参与的商品信息<a class="span" href="javascript:void(0);">×</a></h1>				
							...
							<div class="jwebox_mainlist"><span class="jwebox_mainlist_uspecies">您的账户余额：<span class="jwebox_uspecies" ></span>参与币</span></div>	
		...
		if(shopnum>3000){
			$(".jwebox_shop_relog").text('参与人次大于3000会产生多条购买记录！');
			setTimeout(function(){
