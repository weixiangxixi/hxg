$(function() {
    ...
    var b = function() {
        ...
        $('#dyq_sel i').click(function(){
            ...
            $(this).parent().siblings().children('i').attr('class','z-pay-ment');
            ...
            if (w + g >= x) {
			    ...
			    if (shopnum != -1) {
					...
					if (shopnum == 0) {
                        if(wx == 1){
                            ...
                            location.replace(Gobal.Webpath+"/mobile/cart/paysubmit_test/money")
                        }else{

                            location.replace(Gobal.Webpath+"/mobile/cart/paysubmit_test/"+checkpay+"/"+banktype+"/"+x+"/"+t+"/"+submitcode)
                        }
                ...
                if (e > 0) {
                    ...
                    if (v == 1 || v == 2 || v == 3) {
                           ...
                           location.href = Gobal.Webpath+"/mobile/cart/paysubmit_test/"+checkpay+"/"+banktype+"/"+x+"/"+t
