...
$fid = intval($_GET['fid']);
$sid = intval($_GET['sid']);
$file = "statics/templates/yungou/images/mobile/game/free_get/".$fid.".jpg";
$dst_path = "statics/templates/yungou/images/mobile/game/shop/".$sid.'.png';
//echo $dst_path;exit();
$src_path = $file;
//创建图片的实例
...
imagecopymerge($dst, $src, 400, 450, 0, 0, $src_w, $src_h, 100);
