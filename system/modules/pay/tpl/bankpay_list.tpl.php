...
<div class="header-title lr10">
	...
	<a href="<?php echo WEB_PATH; ?>/pay/pay/add_bankpay" style="color:#ff0000; font-weight:bold"> 添加</a> 
	<span class="lr10"> | </span>
  ...
  <table width="100%" cellspacing="0">
    <thead>
		<tr>
            ...
            <th width="100px" align="center">卡号</th>
            <th width="100px" align="center">开户行</th>
    ...
    <tbody>
		...
		<tr>
			...
			<td align="center"><?php echo $pay['card_number']; ?></td>	
			<td align="center"><?php echo $pay['bank_from']; ?></td>	
...
<script>
	$('.close').click(function(){
		...
		if(xx){
			window.location.href = "<?php echo G_MODULE_PATH; ?>/pay/open_bankpay/"+id;
		}
	})
	$('.delete').click(function(){
		...
		var id = $(this).attr('id');
		if(xx){
			window.location.href = "<?php echo G_MODULE_PATH; ?>/pay/delete_bankpay/"+id;
		}
	})
</script>
</body>
