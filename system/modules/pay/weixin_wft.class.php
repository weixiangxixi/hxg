...
//			header('Location: '.WEB_PATH.'/pay/weixin_wft_url/payinfo/nowechat');
//			die;
//		}
//
//		include_once dirname(__FILE__)."/wxpay1/WxPayPubHelper.php";
//
//		if ( !$config ) {
...
//
//		if (!isset($_GET['code'])){
//			$url = G_WEB_PATH.'/index.php/pay/weixin_wft_url/?money='.$config['money'].'&out_trade_no='.$config['code'];
