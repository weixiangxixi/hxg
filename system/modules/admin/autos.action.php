...
class autos extends admin {	
	...
	public function show(){
		...
		$data  = $this->db->GetOne("SELECT `cfg_value` FROM `@#_wxch_cfg` WHERE  `cfg_name` = 'auto1'  LIMIT 1");
		...
		include $this->tpl(ROUTE_M,'autos.show');
	...
	public function show_2(){
		...
		$data  = $this->db->GetOne("SELECT `cfg_value` FROM `@#_wxch_cfg` WHERE  `cfg_name` = 'auto1_2'  LIMIT 1");
		$data = unserialize($data['cfg_value']);
		$times = intval($data['mintime']);  //最小间隔时间
		$endtimes = intval($data['maxtime']);  //最大间隔时间
		$shopid = $data['shopid'];//商品ID 以“-” 分割
		...
		include $this->tpl(ROUTE_M,'autos.show_2');
	...
	public function show_3(){
		...
		$data  = $this->db->GetOne("SELECT `cfg_value` FROM `@#_wxch_cfg` WHERE  `cfg_name` = 'auto1_3'  LIMIT 1");
		$data = unserialize($data['cfg_value']);
		$times = intval($data['mintime']);  //最小间隔时间
		$endtimes = intval($data['maxtime']);  //最大间隔时间
		$shopid = $data['shopid'];//商品ID 以“-” 分割
		...
		include $this->tpl(ROUTE_M,'autos.show_3');
	...
	public function show_4(){
		...
		$data  = $this->db->GetOne("SELECT `cfg_value` FROM `@#_wxch_cfg` WHERE  `cfg_name` = 'auto1_4'  LIMIT 1");
		$data = unserialize($data['cfg_value']);
		$times = intval($data['mintime']);  //最小间隔时间
		$endtimes = intval($data['maxtime']);  //最大间隔时间
		$shopid = $data['shopid'];//商品ID 以“-” 分割
		...
		include $this->tpl(ROUTE_M,'autos.show_4');
	...
	public function show_5(){
		...
		$data  = $this->db->GetOne("SELECT `cfg_value` FROM `@#_wxch_cfg` WHERE  `cfg_name` = 'auto1_5'  LIMIT 1");
		$data = unserialize($data['cfg_value']);
		$times = intval($data['mintime']);  //最小间隔时间
		$endtimes = intval($data['maxtime']);  //最大间隔时间
		$shopid = $data['shopid'];//商品ID 以“-” 分割
		...
		include $this->tpl(ROUTE_M,'autos.show_5');
	...
	public function stop(){
			...
			$data['on'] = 0;
			$data = serialize($data);
			$rs = $this->db->Query("UPDATE `@#_wxch_cfg` SET `cfg_value` = '$data' WHERE `cfg_name` = 'auto1'");
			if($rs){
				echo "设置关闭成功";exit;
			}else{
				echo "设置关闭失败";exit;
	...
	public function stop2(){
			...
			$data['on'] = 0;
			$data = serialize($data);
			$rs = $this->db->Query("UPDATE `@#_wxch_cfg` SET `cfg_value` = '$data' WHERE `cfg_name` = 'auto1_2'");
			if($rs){
				echo "设置关闭成功";exit;
			}else{
				echo "设置关闭失败";exit;
	...
	public function stop3(){
			...
			$data['on'] = 0;
			$data = serialize($data);
			$rs = $this->db->Query("UPDATE `@#_wxch_cfg` SET `cfg_value` = '$data' WHERE `cfg_name` = 'auto1_3'");
			if($rs){
				echo "设置关闭成功";exit;
			}else{
				echo "设置关闭失败";exit;
	...
	public function stop4(){
			...
			$data['on'] = 0;
			$data = serialize($data);
			$rs = $this->db->Query("UPDATE `@#_wxch_cfg` SET `cfg_value` = '$data' WHERE `cfg_name` = 'auto1_4'");
			if($rs){
				echo "设置关闭成功";exit;
			}else{
				echo "设置关闭失败";exit;
	...
	public function stop5(){
			...
			$data['on'] = 0;
			$data = serialize($data);
			$rs = $this->db->Query("UPDATE `@#_wxch_cfg` SET `cfg_value` = '$data' WHERE `cfg_name` = 'auto1_5'");
			if($rs){
				echo "设置关闭成功";exit;
			}else{
				echo "设置关闭失败";exit;
	...
	public function ajaxaction(){
			...
			$temp["runtime"] = time();
			$temp = serialize($temp);
			$rs = $this->db->Query("UPDATE `@#_wxch_cfg` SET `cfg_value` = '$temp' WHERE `cfg_name` = 'auto1'");
			if($rs){
		...
		public function ajaxaction2(){
			...
			$temp["runtime"] = time();
			$temp = serialize($temp);
			$rs = $this->db->Query("UPDATE `@#_wxch_cfg` SET `cfg_value` = '$temp' WHERE `cfg_name` = 'auto1_2'");
			if($rs){
				echo "配置成功，请打开指定触发页面开始";exit;
			}else{
				echo "配置失败";exit;
		...
		public function ajaxaction3(){
			...
			$temp["runtime"] = time();
			$temp = serialize($temp);
			$rs = $this->db->Query("UPDATE `@#_wxch_cfg` SET `cfg_value` = '$temp' WHERE `cfg_name` = 'auto1_3'");
			if($rs){
				echo "配置成功，请打开指定触发页面开始";exit;
			}else{
				echo "配置失败";exit;
		...
		public function ajaxaction4(){
			...
			$temp["runtime"] = time();
			$temp = serialize($temp);
			$rs = $this->db->Query("UPDATE `@#_wxch_cfg` SET `cfg_value` = '$temp' WHERE `cfg_name` = 'auto1_4'");
			if($rs){
				echo "配置成功，请打开指定触发页面开始";exit;
			}else{
				echo "配置失败";exit;
		...
		public function ajaxaction5(){
			...
			$temp["runtime"] = time();
			$temp = serialize($temp);
			$rs = $this->db->Query("UPDATE `@#_wxch_cfg` SET `cfg_value` = '$temp' WHERE `cfg_name` = 'auto1_5'");
			if($rs){
				echo "配置成功，请打开指定触发页面开始";exit;
			}else{
				echo "配置失败";exit;
