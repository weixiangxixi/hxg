...
// System::load_app_fun("plug",G_ADMIN_DIR);
// System::load_sys_fun("plug");
...
class index extends admin {
	...
	public function init(){	
		$info=$this->AdminInfo;
		$path = "http://download.yungoucms.com/yungou/newpatch/";
		if(G_CHARSET=='utf-8'){
				$path.= 'utf8/';
		...
		// }
		// $path = G_HTTP_HOST;
		// $kurl = 'http://api.ytptw.com/api.php?host='.$path.'&type=2 ';
		// $ret = getCurl($kurl);
		// $menu_arr = json_decode($ret, true);
	...
	public function authorization(){
		echo "该插件为唐唐参与付费插件，插件请登录http://kf.oo17.cn查看下载！";
	}
}
?>