...
<!--start-->
  <table width="100%" cellspacing="0">
    <thead>
		<tr>
		<th width="80px">id</th>
		<th width="100px" align="center">链接名称1</th>
    ...
    <tbody>
		...
		<tr>
			...
			<td align="center">
				<a href="<?php echo WEB_PATH; ?>/admin/link/modifiylink/<?php echo $v['id'];?>">修改</a>
                <span class='span_fenge lr5'>|</span>
				<a href="<?php echo WEB_PATH; ?>/admin/link/dellink/<?php echo $v['id'];?>" onClick="return confirm('是否真的删除！');">删除</a>
			</td>	
		</tr>
		<?php } ?>
  	</tbody>
