...
<?php 
echo "<p><a href='/admin/dingdan1/edit_command'>修改支付宝口令</a></p>";
if($set_open['open'] == 0){
    echo "<p>当前状态：收款关闭中....操作：&nbsp;&nbsp;&nbsp;<a href='/admin/dingdan1/check_wxpay_open/1'>【开启】</a></p>";
}else{
    echo "<p>当前状态：收款开启中....操作：&nbsp;&nbsp;&nbsp;<a href='/admin/dingdan1/check_wxpay_open/0'>【关闭】</a></p>";
}
if($song_open['open'] == 0){
...
<!--start-->
  <table width="100%" cellspacing="0">
    <thead>
		<tr>
        	<th align="center">转账用户账号</th>
            <th align="center">转账用户姓名</th>
    ...
    <tbody>
		<?php foreach($recordlist AS $v) {	?>		
            <tr>
                <td align="center"><span style="font-size: 20px;color:red;"><?php echo $v["alipay_account"];?></span></td>
                <td align="center"><span style="font-size: 50px;color:red;"><?php echo $v["alipay_name"];?></span></td>
                ...
                <td align="center"><a style="font-size: 50px;color:red;" onclick="post_ajax(<?php echo $v['id']; ?>);"><?php if($v['status']==0){echo '收款';} ?></a>
...
<script>
    ...
    function post_ajax(id){
        ...
        //{ 
            $.ajax({  
                type:'post',    
                url:'/index.php/admin/dingdan1/check_wxpay',  
                data:{
                    id : id
                }, 
                dataType:'json',  
