...
<form name="myform" action="" method="post">
  ...
  <table width="100%" cellspacing="0" >
		...
		<tr class="watermark_image">
            ...
            <input type="text" name="shopid" value="<?php echo $this->segment(4); ?>"  class="input-text">商品ID请从<font style="color:red">（商品管理》商品列表）</font>的id选择，已开奖项目不能添加！
		...
		<tr class="watermark_image">
			...
			<td><input type="text" name="userid" value=""  class="input-text"><span> 会员ID从 <font style="color:red">（用户管理》会员列表）</font>中 选择</span></td>
