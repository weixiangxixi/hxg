...
<form method="post" action="" onSubmit="return CheckForm()">
	<table width="100%"  cellspacing="0" cellpadding="0">
        ...
        <tr>
			<td align="right" style="width:120px"><font color="red">*</font>限购人次</td>
			<td><input type="text" id="xg_num"  name="xg_num" style="width:65px; padding-left:0px; text-align:center" class="input-text"></td>
		</tr>
        <tr>      
			<td align="right" style="width:120px"><font color="red">*</font>压力测试次数：</td>     
            <td><input type="text" name="buynum"  class="input-text" style="width:65px; padding-left:0px; text-align:center">
             </td>
		</tr>
		<tr>      
			<td align="right" style="width:120px"><font color="red">*</font>压力测试次数2：</td>     
            <td><input type="text" name="buynum2"  class="input-text" style="width:65px; padding-left:0px; text-align:center">
             </td>
		</tr>
