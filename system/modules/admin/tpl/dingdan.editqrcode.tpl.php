 ...
 <div class="header-data lr10">
    ...
    <script type="text/javascript">
        function add_user(){
            if(confirm('确定要新建吗?')) 
            { 
                $.post("/index.php/admin/dingdan/add_wxpay_user", { id: "1"} );
                location.reload();
            } 
        }
  ...
  <style>
    tr th:nth-child(2),th:nth-child(3),th:nth-child(4),th:nth-child(5),th:nth-child(6),th:nth-child(7),th:nth-child(8),th:nth-child(9),th:nth-child(10),th:nth-child(11),th:nth-child(12),th:nth-child(13){
    	display:none;
    }
    tr td:nth-child(2),td:nth-child(3),td:nth-child(4),td:nth-child(5),td:nth-child(6),td:nth-child(7),td:nth-child(8),td:nth-child(9),td:nth-child(10),td:nth-child(11),td:nth-child(12),td:nth-child(13){
    	display:none;
    }
  </style>
<div class="bk10"></div>
  ...
  <table width="100%" cellspacing="0">
    ...
    <tbody>
        <?php foreach($val['list'] AS $k=>$v) {  ?> 
            <tr>
                <td align="center" style="cursor: pointer;" onclick="edit(<?php echo $v['id']; ?>)">用户<?php echo $v["zhi"]."(".$v["name"].")";?> </td>
                <td align="center"><a href="/admin/dingdan/edit_qrcode_img/<?php echo $v['zhi']; ?>/10">修改</a></td>              
                <td align="center"><a href="/admin/dingdan/edit_qrcode_img/<?php echo $v['zhi']; ?>/20">修改</a></td>
                <td align="center"><a href="/admin/dingdan/edit_qrcode_img/<?php echo $v['zhi']; ?>/30">修改</a></td>              
                <td align="center"><a href="/admin/dingdan/edit_qrcode_img/<?php echo $v['zhi']; ?>/50">修改</a></td>
                <td align="center"><a href="/admin/dingdan/edit_qrcode_img/<?php echo $v['zhi']; ?>/100">修改</a></td>              
                <td align="center"><a href="/admin/dingdan/edit_qrcode_img/<?php echo $v['zhi']; ?>/200">修改</a></td>
                <td align="center"><a href="/admin/dingdan/edit_qrcode_img/<?php echo $v['zhi']; ?>/300">修改</a></td>              
                <td align="center"><a href="/admin/dingdan/edit_qrcode_img/<?php echo $v['zhi']; ?>/500">修改</a></td>
                <td align="center"><a href="/admin/dingdan/edit_qrcode_img/<?php echo $v['zhi']; ?>/1000">修改</a></td>              
                <td align="center"><a href="/admin/dingdan/edit_qrcode_img/<?php echo $v['zhi']; ?>/2000">修改</a></td>
                <td align="center"><a href="/admin/dingdan/edit_qrcode_img/<?php echo $v['zhi']; ?>/5000">修改</a></td>
