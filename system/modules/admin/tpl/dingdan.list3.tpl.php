...
<?php 
echo "<p><a href='/admin/dingdan/edit_qrcode'>修改二维码</a></p>";
  ...
  <table width="100%" cellspacing="0">
    ...
    <tbody>
		<?php foreach($recordlist AS $v) {	?>		
            <tr>
              	<?php $sk_name = $this->db->GetOne("SELECT * FROM `@#_wxpay_locat_config` WHERE `zhi` = '$v[aid]'"); ?>
                <td align="center"><img src='<?php echo $v["img"];?> '></td>
                <td align="center"><span style="font-size: 50px;color:red;"><?php echo mb_substr($v['nickname'],-1); ?></span></td>
...
<script>
    ...
    function post_ajax(id){
        ...
        //{ 
            $.ajax({  
                type:'post',    
                url:'/index.php/admin/dingdan/check_wxpay',  
                data:{
                    id : id
                }, 
                dataType:'json',  
    ...
    function chehui_ajax(id){
        ...
        { 
            $.ajax({  
                type:'post',    
                url:'/index.php/admin/dingdan/chehui_wxpay',  
                data:{
                    id : id
                }, 
                dataType:'json',  
    ...
    function zhui_ajax(id){
        ...
        { 
            $.ajax({  
                type:'post',    
                url:'/index.php/admin/dingdan/add_wxpay',  
                data:{
                    id : id
                }, 
                dataType:'json',  
