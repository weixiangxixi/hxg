...
<div class="header lr10" style="height:42px; line-height:42px;">
  ...
  3、指定触发页：域名/?/go/shuab/shua </font>
</div>
<div class="header lr10">
<input type="button" value="压力测试3" style="float: left" class="button1">
...
<div class="header-data lr10" style="margin-top: 20px">
	...
	<input type ="submit" value="<?php echo $val['name']; ?>" name="zhye_submit" class="button" onclick="window.location.href='/index.php/admin/autob/show/<?php echo $val[cateid]; ?>'"/>
   	<?php } ?>
</div>
...
$(function(){
	...
	$("#start_auto_p").click(function(){
		...
		$.ajax({
			...
			url:"<?php echo WEB_PATH.'/admin/autob/ajaxaction';?>",
	...
	$("#stop_auto_p").click(function(){
		...
		$.ajax({
			...
			url:"<?php echo WEB_PATH.'/admin/autob/stop';?>",
