...
<!--start-->
		...
		<div class="dingdan_content_user">
			...
			<li><b class="api_b">获得时间：</b><?php echo date("Y-m-d H:i:s",$record['created_at']);?></li>	
		...
		<div class="dingdan_content_user" style="margin-left: 20px;">
			...
			<li><b class="api_b" style="text-align: center;font-size: 16px;">商品名称：</b><span style="text-align: center;font-size: 18px;color: red;margin-left: 20px"><?php echo $record['shopname']; ?></span></li>
