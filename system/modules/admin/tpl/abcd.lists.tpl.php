	...
	<?php if($this->segment(4)!='xianshi' && $this->segment(4)!='maxqishu' && $this->segment(4)!='moneyasc' && $this->segment(4)!='money'): ?>
        ...
        <tbody>				
            ...
            <tr>
                ...
                <td><input type="checkbox" value="<?php echo $v['id'];?>" <?php $checkbox = $this->db->GetOne("SELECT * FROM `@#_appoint` where test=0 and shopid=".$v['id']);if(!empty($checkbox)){echo 'checked="checked"';}  ?> name="shoparr"></td>
                ...
                <td><?php $app = $this->db->GetOne("SELECT * FROM `@#_appoint` where test=0 and shopid=".$v['id']);if(!empty($app)){echo '已指定';} ?></td>
				...
				[<a href="<?php echo G_ADMIN_PATH; ?>/abcd/specify/<?php echo $v['id'];?>">指定</a>]  
				
                [<a href="<?php echo G_ADMIN_PATH; ?>/abcd/pay_list/<?php echo $v['id'];?>">消费记录</a>]              
...
<script>
    ...
    function dothis(shopid){
        ...
        $.post("/index.php/admin/abcd/add_goods1/", { shopid: shopid},
            function(data){
               alert(data);
               // location.reload();
        });
   ...
   function del(shopid){
        ...
        $.post("/index.php/admin/abcd/del_goods/", { shopid: shopid},
            function(data){
               alert(data);
               // location.reload();
        });
  ...
  $(function(){
	$("#test").click(function(){
		...
		//alert(cateval);
      	$.post("/index.php/admin/abcd/addAllGoods/", { cateid: cateval},
            function(data){
               alert(data);
               // location.reload();
        });
   ...
   $(function(){
	$("#test2").click(function(){
		...
		var cateval = $('.cateid').val();							 
		//alert(cateval);
      	$.post("/index.php/admin/abcd/addAllGoods2/", { cateid: cateval},
            function(data){
               alert(data);
               // location.reload();
        });
