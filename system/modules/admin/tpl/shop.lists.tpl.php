...
<div class="header-data lr10">
	...
	<b>提示:</b> 因为商品添加后参与码已经生成成功,所以不能在本期内修改价格了.
...
<form action="#" method="post">
 ...
 添加时间: <input name="posttime1" type="text" id="posttime1" value="<?php echo !empty($posttime1)?date("Y-m-d H:i:s",$posttime1):''?>" class="input-text posttime"  readonly="readonly" /> -  

 		  <input name="posttime2" type="text" id="posttime2" value="<?php echo !empty($posttime2)?date("Y-m-d H:i:s",$posttime2):''?>" class="input-text posttime"  readonly="readonly" />
...
<option value="title" <?php if($sotype=='title'){echo "selected";} ?>>商品标题</option>

<option value="id" <?php if($sotype=='id'){echo "selected";} ?>>商品id</option>

<option value="cateid" <?php if($sotype=='cateid'){echo "selected";} ?>>栏目id</option>

<option value="catename" <?php if($sotype=='catename'){echo "selected";} ?>>栏目名称</option>

<option value="brandid" <?php if($sotype=='brandid'){echo "selected";} ?>>品牌id</option>

<option value="brandname" <?php if($sotype=='brandname'){echo "selected";} ?>>品牌名称</option>

</select>

<input type="text" name="sosotext" value="<?php echo $sosotext; ?>" class="input-text wid100"/>
...
<div class="header-data lr10" style="margin-top: 20px">
    ...
    <input type ="submit" value="<?php echo $val['name']; ?>" name="zhye_submit" class="button" onclick="window.location.href='/index.php/admin/content/goods_list/<?php echo $val[cateid]; ?>'"/>
    <?php } ?>
</div>
<div class="bk10"></div>
        ...
        <tbody>				
            ...
            <tr>
              ...
              <td align='center'><input name='listorders[<?php echo $v['id']; ?>]' type='text' size='3' value='<?php echo $v['order']; ?>' class='input-text-c'></td>  
                ...
                [<a class="del" id="<?php echo $v['id']; ?>" href="javascript:;">删除</a>]
