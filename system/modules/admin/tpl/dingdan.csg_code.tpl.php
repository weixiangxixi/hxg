...
<!--start-->
		...
		<div class="dingdan_content_user">
			...
			<li><b class="api_b">获得时间：</b><?php echo date("Y-m-d H:i:s",$record['update_time']);?></li>	
		...
		<div class="dingdan_content_user" style="margin-left: 20px;">
			...
			<li><b class="api_b" style="text-align: center;font-size: 16px;">商品名称：</b><span style="text-align: center;font-size: 18px;color: red;margin-left: 20px"><?php echo $record['name']; ?></span></li>
			<li><b class="api_b" style="text-align: center;font-size: 16px;">参与时间：</b><span style="text-align: center;font-size: 18px;color: red;margin-left: 20px"><?php echo date("Y-m-d H:i:s",$record['create_time']); ?></span></li>
			<li><b class="api_b" style="text-align: center;font-size: 16px;">获得时间：</b><span style="text-align: center;font-size: 18px;color: red;margin-left: 20px"><?php echo date("Y-m-d H:i:s",$record['update_time']); ?></span></li>
