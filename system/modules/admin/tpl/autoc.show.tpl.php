...
<div class="header-data lr10" style="margin-top: 20px">
	...
	<input type ="submit" value="<?php echo $val['name']; ?>" name="zhye_submit" class="button" onclick="window.location.href='/index.php/admin/autoc/show/<?php echo $val[cateid]; ?>'"/>
   	<?php } ?>
</div>
...
$(function(){
	...
	$("#start_auto_p").click(function(){
		...
		$.ajax({
			...
			url:"<?php echo WEB_PATH.'/admin/autoc/ajaxaction';?>",
	...
	$("#stop_auto_p").click(function(){
		...
		$.ajax({
			...
			url:"<?php echo WEB_PATH.'/admin/autoc/stop';?>",
