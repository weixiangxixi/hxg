...
<link rel="Shortcut Icon" href="http://f.weimicm.com/photo/member.jpg@!thumb_110_110">
...
.left_date a{color:#eee;}
.left_date li span{background: url(<?php echo G_WEB_PATH; ?>/statics/plugin/style/global/image/narrow.png);display:inline-block; height: 35px; margin-left: 15px; width: 10px;}
.left_date{overflow:hidden;}

.left_date ul{ margin:0px; padding:0px;}

.left_date li{line-height:35px; height:35px; overflow:hidden;}

.left_date li a{ display:inline-block;text-indent:1em;  overflow:hidden;}

.left_date li:hover{ background-color:#161e22;text-decoration:none;border-bottom:1px solid #3c8dbc; color: #FFF;height: 34px; cursor: pointer;}

.left_date .set{background-color:#161e22;font-weight:bold;color:#3c8dbc;}

.left_date .head{ border-bottom:1px solid #c5e8f1; color:#FFF; font-weight:bold;background: #161e22;padding-left:15px; height: 34px;}
...
<div id="header">
    ...
    欢迎您：<a href="javascript:;" title="<?php echo $info['username']; ?>"><?php echo $info['username']; ?></a>

    <a href="<?php echo G_MODULE_PATH; ?>/dissyou/out" title="退出">[退出]</a>
...
<div id="left">
    ...
    <ul class="left_date" id="setting">   
    	...
    	<li class="head">站点设置</li>
    	               ...
    	               <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/setting/config">基本设置</a></li>
                            ...
                            <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/pay/pay/bankpay_list">银行支付管理</a></li>
		...
		<li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dissyou/lists">管理员管理</a></li>

                        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dissyou/reg">添加管理员</a></li>

                        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dissyou/edit/<?php echo $info['uid']; ?>">修改密码</a></li>
	...
	<li class="head">站长运营</li>
     ...
     <ul class="left_date" id="content">
        ...
        <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/group/quanzi">圈子模块</a></li>  
        ...
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/menu/lists">手机导航</a></li>
     ...
     <ul class="left_date" id="shop">   
        ...
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/goods_list1">商品列表</a></li>

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/goods_add">添加新商品</a></li>  

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/goods_exchange_list">兑换商品列表</a></li>  

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/goods_exchange_add">添加新兑换商品</a></li>

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/goods_csg_list">闯三关商品列表</a></li>  

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/goods_csg_add">添加新闯三关商品</a></li>

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/category/lists/goods">商品分类</a></li> 
        ...
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/phone/order">手机查单</a></li>
        
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/goods_list_xg">限购商品列表</a></li>
        
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/goods_add_xg">添加新限购商品</a></li>

        <li class="head">商品其他</li>

        <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/api/position/lists">推荐位管理</a></li>     

        <li class="head">订单管理</li>
		
       	<li <?php $CheckId = _encrypt(_getcookie("AID"), 'DECODE');if($CheckId!=1){echo "style='display:none;'";} ?>><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/edit_pay">充值通道设置</a></li> 

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/wxpay">微信扫码充值订单</a></li> 

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan1/alipay_sm">支付宝扫码充值订单</a></li> 

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan1/alipay">支付宝充值订单</a></li> 

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan2/bank">银行卡充值订单</a></li>
       ...
       <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/lists">订单列表</a></li>
        ...
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/zhongjiang">中奖订单</a></li> 

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/lists/notsend">未发货订单</a></li> 

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/exchange_shop">兑换商品订单</a></li>		

        <li><span></span>....</li> 

        <li class="head">促销管理</li>

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/content/goods_list/xianshi">限时揭晓商品</a></li>

        <li class="head">其他</li>

        <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/go/shaidan_admin/init">晒单查看</a></li>

        <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/admin/content/goods_shaidan_list">晒单</a></li>
	...
	<li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/member/member/select">查找会员</a></li> 	
            ...
            <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/member/member/config">会员配置</a></li>
       		...
       		<li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/test/vip_song">VIP充值赠送设置</a></li>

            <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/member/member/recharge">充值记录</a></li>

            <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/member/member/pay_list">消费记录</a></li>

	<li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/member/member/member_group">会员组</a></li>

    <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/member/member/commissions">佣金申请提现管理</a></li>
    
    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/test/user_details">用户详情</a></li>
    
    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/test/lottery_details">红包详情</a></li>

    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/test/sck_details">商城卡兑换详情</a></li>

    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/test/zhuan_details">转账明细</a></li>

    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/test/liuliang_details">流量详情</a></li>
	
    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/fifa/history">世界杯竞猜</a></li>

    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/test/in_out">收支查询</a></li>

    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/test/tfzx">中奖-充值-消费查询</a></li>

    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/test/jfxq">签到积分详情</a></li>

    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/mk_dingdan">秒款确认发货</a></li>
       
    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/dh_mk_dingdan">兑换秒款确认发货</a></li>

    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/csg_mk_dingdan">闯三关秒款确认发货</a></li>

    <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/dingdan/csg_all_dingdan">闯三关中奖订单</a></li>
    ...
    <ul class="left_date" id="template">   
        ...
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/ments/navigation">导航条管理</a></li>

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/slide">幻灯管理</a></li>
            
        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/wap">手机幻灯管理</a></li>

        <li><span></span><a href="javascript:void(0);" src="<?php echo G_MODULE_PATH; ?>/recom">推荐位图片</a></li>
     ...
     <ul class="left_date" id="yunapp">     	
		...
		<li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/admin/fund/fundset">公益基金</a></li>
                        ...
                        <li><span></span><a href="javascript:void(0);" src="<?php echo WEB_PATH; ?>/api/activity/config">活动管理</a></li>
    </ul>
