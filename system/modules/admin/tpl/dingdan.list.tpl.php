...
<div class="header lr10">
    ...
    <?php if($where == 'sendok'){ ?><input type="text" name="shopname" value="<?php echo $shopname; ?>" class="input-text" placeholder="输入标题" style="width: 200px" /> <?php } ?>
	<input type ="submit" value=" 确定 " name="paixu_submit" class="button"/>
    </form>
</div>
<div class="bk10"></div>
