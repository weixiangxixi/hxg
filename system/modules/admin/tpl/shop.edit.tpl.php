	...
	<table width="100%"  cellspacing="0" cellpadding="0">
    	<tr style="background-color:#FFe;height:50px;">
			...
			<td>
				...
				单次参与价格	<b style="color:red"><?php echo $shopinfo['yunjiage']; ?></b>&nbsp;&nbsp;&nbsp;
		...
		<tr>
			...
			<td>
				<span style="font-size: 16px">否</span><input type="radio" name="shop_card" value="0" style="width: 20px;height: 20px" <?php if($shopinfo['str1'] == 0){echo "checked";} ?>>
				<span style="font-size: 16px;margin-left: 18px">是</span><input type="radio" name="shop_card" value="1" style="width: 20px;height: 20px" <?php if($shopinfo['str1'] != 0){echo "checked";} ?>>
				<span style="margin-left: 20px;<?php if($shopinfo['str1'] == 0){echo 'display: none';} ?>" id="shop_money">商城卡面额：
					<select name="shop_money">
						<?php if($shopinfo['str1'] == 0){echo '<option value="0">请选择面额</option>';}else{echo '<option value="'.$shopinfo["str1"].'">'.$shopinfo["str1"].'元</option>';} ?>
		...
		<?php if($shopinfo['cateid'] == '170'){ ?>
		<tr>
			<td align="right" style="width:120px"><font color="red">*</font>全返商品总价格：</td>
			<td><input type="text" value="<?php echo $shopinfo['str3'];?>" id="qf_shop_money"  name="qf_shop_money" onKeyUp="value=value.replace(/\D/g,'')" style="width:65px; padding-left:0px; text-align:center" class="input-text">元</td>
		</tr>
		<?php } ?>
        <tr>      
