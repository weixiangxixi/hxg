...
class wxorder1 extends SystemAction {
	...
	public function init(){
		$url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.$this->conf['weixin']['id'].'&redirect_uri='.WEB_PATH.'/api/wxorder1/callback&response_type=code&scope=snsapi_userinfo&state=wechat123&connect_redirect=1#wechat_redirect';
		header("location:$url");
	}
	//wexin回调
	public function callback(){
		...
		if (!empty($_SESSION['img'] )) {
			header("location:/mobile/home/userrecharge6");
		}else{
