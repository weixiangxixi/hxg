...
class wxorder6 extends SystemAction {
	...
	public function __construct(){	
        ...
        $this->appid = 'wx23c6446caae838de';
        $this->secret = '53feb6a3d9606ba63b0747af47638b0f';
      	$this->db = System::load_sys_class("model");
	}
	//wexin登录
	public function init(){
		$url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.$this->appid.'&redirect_uri='.WEB_PATH.'/api/wxorder5/callback&response_type=code&scope=snsapi_userinfo&state=wechat123&connect_redirect=1#wechat_redirect';
		header("location:$url");
	}
	//wexin回调
	public function callback(){
		...
		header('Location:/index.php/mobile/home/userrecharge3');
	}
	//wexin回调
