...
class wxorder55 extends SystemAction {
	...
	public function init(){
		...
		_setcookie("uid",_encrypt($member['uid']),60*60*24*7);
      	...
      	$_SESSION['uid'] = $uid;
      	*/
		$url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.$this->appid.'&redirect_uri='.WEB_PATH.'/api/wxorder55/callback&response_type=code&scope=snsapi_userinfo&state=wechat123&connect_redirect=1#wechat_redirect';
		header("location:$url");
	}
	//wexin回调
	public function callback(){
		...
		$_SESSION['openid']= $weixin_openid;
      	...
      	header('Location:/index.php/mobile/cart/paysubmit/money/');
