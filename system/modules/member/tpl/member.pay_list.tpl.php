...
<div style="margin-bottom:5px;">搜索的全返金额：<span style="color:red;font-weight:bold;"><?php echo $qf_money;?>元</span></div>
<div style="margin-bottom:5px;">消费金额：<span style="color:red;font-weight:bold;"><?php echo $summoeny['sum_money']-$qf_money;?>元</span></div>
