  ...
  <table width="100%" cellspacing="0">
    ...
    <thead>
		...
		<tr>
            ...
            <th width="100px" align="center">退款金额</th>

            <th width="100px" align="center">二维码</th>
    ...
    <tbody>
    	...
    	<?php foreach($members as $v){ ?>
			...
			<tr>
				...
				<td align="center"><?php echo $v['zh_money']; ?></td>	

				<td align="center"><?php echo $v['money']; ?></td>

				<td align="center"><?php if(!empty($v['img'])){echo "<a style='cursor:pointer' class='look' id='".$v['img']."'>预览</a>";}else{echo "未上传";} ?></td>	 

				<td align="center">

					<?php if($v['status'] == 1){echo "已退款";}else{echo "<a href='".G_MODULE_PATH."/member/sure_tuikuan/".$v['uid']."'>确定</a>";} ?>
...
<div style="position: relative;display: none" id="show"><img src="" style="width:300px;height:300px;margin:10% 40%"></div>

<div id="pages"><ul><li>共 <?php echo $total; ?> 条</li><?php echo $page->show('one','li'); ?></ul></div>

<script>
	$('.look').click(function(){
		var xx = "/statics/uploads/linkimg/"+$(this).attr('id');
		$('#show img').attr('src',xx);
		$('#show').show();
	})
