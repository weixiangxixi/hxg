  ...
  <table width="100%" cellspacing="0">
  	 <tr>
		...
		<tr>
			...
			<td><input type="text" name="money" disabled="disabled" value="<?php echo $member['money'];?>" class="input-text">元</td>
		</tr>
		<tr>
		...
		<tr>
			<td width="120" align="right">查看订单权限：</td>
			<td>
				<input type="radio" name="order_auth" value="0" <?php echo $member['order_auth']=='0'?'checked':'';?> class="input-text">无
				<input type="radio" name="order_auth" value="1" <?php echo $member['order_auth']=='1'?'checked':'';?> class="input-text">有
			</td>
		</tr>
		<tr>
			<td width="120" align="right">转账权限：</td>
			<td>
				<input type="radio" name="zhuan_status" value="0" <?php echo $member['zhuan_status']=='0'?'checked':'';?> class="input-text">无
				<input type="radio" name="zhuan_status" value="1" <?php echo $member['zhuan_status']=='1'?'checked':'';?> class="input-text">有
			</td>
		</tr>
		<tr>
			<td width="120" align="right">vip权限：</td>
			<td>
				<input type="radio" name="vip" value="0" <?php echo $member['vip']=='0'?'checked':'';?> class="input-text">无
				<input type="radio" name="vip" value="1" <?php echo $member['vip']=='1'?'checked':'';?> class="input-text">有
			</td>
		</tr>
		<tr>
			<td width="120" align="right">绑定号码：</td>
			<td><textarea style="width:400px;height:100px;" name="bind_phone"><?php echo $member['bind_phone'];?></textarea></td>
		</tr>
		<tr>
