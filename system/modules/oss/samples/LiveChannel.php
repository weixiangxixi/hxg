 ...
 * The play url file is named as test.xc, which includes 3 ts files.
...
/**
  ...
  * the url must be signed as shown in the following.) and pulish_url (the url included in the xc file generated in stream pushing) used to push streams.
 */
$play_url = $ossClient->signRtmpUrl($bucket, "test_rtmp_live", 3600, array('params' => array('playlistName' => 'playlist.xc')));
 ...
 * The playlist file is specified to “vod_playlist.xc”, which means that a palylist file named vod_playlist.xc is created after the interface is called.
 */
$current_time = time();
$ossClient->postVodPlaylist($bucket,
    "test_rtmp_live", "vod_playlist.xc", 
