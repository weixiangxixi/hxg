...
<LiveChannelConfiguration>
  ...
  <Target>
     ...
     <PlayListName>hello.xc</PlayListName>
  </Target>
</LiveChannelConfiguration>
BBBB;
...
<CreateLiveChannelResult>
  ...
  <PlayUrls>
    <Url>http://bucket.oss-cn-hangzhou.aliyuncs.com/213443245345/播放列表.xc</Url>
  </PlayUrls>
  <Status>enabled</Status>
...
<Prefix>xxx</Prefix>
  ...
  <LiveChannel>
    ...
    <PlayUrls>
      <Url>http://bucket.oss-cn-hangzhou.aliyuncs.com/1/播放列表.xc</Url>
    </PlayUrls>
    <Status>enabled</Status>
    <LastModified>2015-11-24T14:25:31.000Z</LastModified>
  </LiveChannel>
  <LiveChannel>
    ...
    <PlayUrls>
      <Url>http://bucket.oss-cn-hangzhou.aliyuncs.com/2/播放列表.xc</Url>
    </PlayUrls>
    <Status>enabled</Status>
...
BBBB;
    ...
    public function testLiveChannelConfig()
    {
        ...
        $this->assertEquals('hello.xc', $config->getPlayListName());
        ...
        $this->assertEquals('hello.xc', $config2->getPlayListName());
    }
    ...
    public function testLiveChannelInfo()
    {
        ...
        $this->assertEquals('http://bucket.oss-cn-hangzhou.aliyuncs.com/213443245345/播放列表.xc', $plays[0]);
    }
    ...
    public function testLiveChannelList()
    {
        ...
        $this->assertEquals(1, count($plays));
        $this->assertEquals('http://bucket.oss-cn-hangzhou.aliyuncs.com/1/播放列表.xc', $plays[0]);
        ...
        $this->assertEquals(1, count($plays));
        $this->assertEquals('http://bucket.oss-cn-hangzhou.aliyuncs.com/2/播放列表.xc', $plays[0]);
    }
